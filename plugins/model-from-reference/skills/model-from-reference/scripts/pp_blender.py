...
def seam(ob, axis="X", tol_mm=0.01):
    ...
    try:
        ...
        bm.free()
    # Не методический допуск, а численный порог плоскостности шва: см. §7 —
    # допусков ровно два, и оба про сравнение с референсом, а не про эпсилон.
    return {"ось": axis, "порог_плоскостности_мм": tol_mm,
